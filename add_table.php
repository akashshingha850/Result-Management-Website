...
echo " Result Table Created. Redirecting to Result Panel.";
...
{
    echo " Result table already exist. Please add data to view them.";
    header( "refresh:2;url=teacher.php" );
}
